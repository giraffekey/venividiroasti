...
impl TokenContract {
    ...
    pub fn new_default_meta(owner_id: AccountId, total_supply: U128) -> Self {
        Self::new(
            ...
            FungibleTokenMetadata {
                ...
                name: "Venividiroasti".to_string(),
                symbol: "ROASTI".to_string(),
    ...
    pub fn ft_burn(&mut self, amount: U128) {
        ...
        if amount.0 == balance.0 {
            self.token.accounts.remove(&sender);
        } else {
...
mod tests {
    ...
    fn setup() -> (TokenContract, VMContextBuilder) {
        let mut context = VMContextBuilder::new();

        let contract = TokenContract::new_default_meta(owner(), TOTAL_SUPPLY.into());
